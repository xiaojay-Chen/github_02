        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="/system/user/edit.do" method="post">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data" style="font-size: 10px">
                        <div class="form-group form-inline">
                            <div class="radio"><label><input type="radio" ${user.degree==0?'checked':''} name="degree" value="1">系统管理员</label></div>
                            <div class="radio"><label><input type="radio" ${user.degree==1?'checked':''} name="degree" value="2">管理所有下属部门和人员</label></div>
                            <div class="radio"><label><input type="radio" ${user.degree==2?'checked':''} name="degree" value="3">管理本部门</label></div>
                            <div class="radio"><label><input type="radio" ${user.degree==3?'checked':''} name="degree" value="4">普通员工</label></div>
                        </div>
                    </div>
